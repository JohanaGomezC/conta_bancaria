...
1\. Clone o repositório do Projeto \[Conta Bancária](https://github.com/JohanaGomezC/conta\_bancaria.git) dentro da pasta do \*Workspace\* do Eclipse/STS



```bash

git clone https://github.com/JohanaGomezC/conta\_bancaria.git
...
Desenvolvido por \[\*\*Johana Gómez C\*\*](https://github.com/JohanaGomezC)
